...
main() {
  ...
  readonly show_directory_in_window_status="#[fg=$thm_bg,bg=$thm_blue] #I #[fg=$thm_blue,bg=colour237]$left_separator#[fg=$thm_fg,bg=$thm_gray] #W "
  ...
  readonly show_directory_in_window_status_current="#[fg=colour232,bg=$thm_orange] #I #[fg=$thm_orange,bg=colour237]$left_separator#[fg=colour255,bg=colour237] #(echo '#{pane_current_path}' | rev | cut -d'/' -f-2 | rev) "
